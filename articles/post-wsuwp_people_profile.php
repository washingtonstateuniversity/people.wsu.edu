	...
	<div class="wsuwp-person-card">
		...
		<?php
			...
			if ( is_single() && $degrees && is_array( $degrees ) ) {
				?><ul class="wsuwp-person-education"><?php
				foreach ( $degrees as $degree ) {
					?><li class="degree"><?php echo esc_html( $degree ); ?></li><?php
				}
				?></ul><?php
			}

			if ( is_single() && $classifications && ! is_wp_error( $classifications ) ) {
				?><p class="wsuwp-person-classifications"><?php
			...
			if ( $title || $titles ) {
				?><p class="wsuwp-person-position"><?php
			...
			if ( $departments && ! is_wp_error( $departments ) && ( is_single() || is_search() || ( is_tax() && ! is_tax( 'wsuwp_university_org' ) ) ) ) {
				?><p class="wsuwp-person-department"><?php
			...
			if ( $email || $alt_email ) {
				?><p class="contact wsuwp-person-email"><span class="dashicons dashicons-email"></span><?php
			...
			if ( $phone || $alt_phone ) {
				?><p class="contact wsuwp-person-phone"><span class="dashicons dashicons-phone"></span><?php
			...
			if ( $office || $alt_office || $locations ) {
				?><p class="contact wsuwp-person-office"><span class="dashicons dashicons-location"></span><?php
